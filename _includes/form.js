...
const thisPageUrl = "https://kuligkamil.github.io/2024/08/01/set-goals-you-cant-achieve.html";
...
fetch("https://docs.google.com/forms/u/0/d/e/1FAIpQLSeyCgTOx9wUv1MMaSaU55j_tL8Oty04QzcmzJDtwSlL8TzeMw/formResponse", {
  method: "post",
  headers: {
			'Remote Address': '216.58.208.206:443',
  },
  body: data
})
.then((res) => {
...
.then((txt) => {
  ...
  fetchForm.reset();
  document.getElementById('posturl').value = "https://kuligkamil.github.io/2024/08/01/set-goals-you-cant-achieve.html";
  fetchComments(csvUrl)
})
.catch((err) => {
  console.log(err);
